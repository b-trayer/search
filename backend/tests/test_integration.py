...
class TestDatabaseIntegration:
    ...
    async def test_create_user(self, db_session: AsyncSession):
        user = User(
            username="test_bachelor",
            email="bachelor@test.nsu.ru",
            role="bachelor",
        ...
        assert user.username == "test_bachelor"
        assert user.role == "bachelor"
...
class TestOpenSearchIntegration:
    ...
    async def test_ranking_formula_with_real_hits(self, opensearch_client: AsyncOpenSearch):
        ...
        user_profile = {"role": "bachelor", "specialization": "Физика", "interests": []}
