  ...
  const compare = useCallback(async (
    ...
    try {
      const [r1, r2] = await Promise.all([
        searchDocuments(searchQuery, leftUserId || undefined, leftUserId !== null && leftUserId !== undefined, 1, 20, undefined, 'all'),
        searchDocuments(searchQuery, rightUserId || undefined, rightUserId !== null && rightUserId !== undefined, 1, 20, undefined, 'all'),
      ]);
