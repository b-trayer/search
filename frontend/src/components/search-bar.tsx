...
const SearchBar = ({ query, onQueryChange, onSearch, isLoading }: SearchBarProps) => {
  ...
  return (
    <div className="flex w-full max-w-2xl gap-2 sm:gap-3">
      <div className="relative flex-1">
        ...
        <Input
          ...
          className="h-12 sm:h-14 pl-10 sm:pl-12 pr-4 text-sm sm:text-base shadow-card border-2 border-border focus:border-primary"
        />
      </div>
      <Button
        variant="search"
