      ...
      <div className="flex flex-1 flex-col justify-between">
        ...
        <div className="mt-3 space-y-2">
          ...
          <ScoreDetails
            ...
            finalScore={book.final_score}
            logBm25={book.log_bm25}
            userContrib={book.user_contrib}
            ctrContrib={book.ctr_contrib}
            fType={book.f_type}
            fTopic={book.f_topic}
            fUser={book.f_user}
            ctrFactor={book.ctr_factor}
            smoothedCtr={book.smoothed_ctr}
