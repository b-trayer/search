  ...
  return (
    ...
    >
      <div className="flex items-baseline justify-between gap-2">
        <span className="text-sm font-medium text-notion-text">{scenario.title}</span>
      ...
      <span className="text-xs text-notion-text-tertiary">{scenario.description}</span>
